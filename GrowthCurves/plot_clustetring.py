...
timeseries_keys = np.array(timeseries_dict.keys())
np_array_timeseries = np.array(timeseries_list)
distance_array = compute_condensed_distance_matrix(np_array_timeseries[:50])
clustering_based_distances(distance_array,timeseries_keys[:50],'single')